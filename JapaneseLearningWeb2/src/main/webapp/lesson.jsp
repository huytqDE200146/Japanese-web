...
<%
    ...
    // Giữ lại completedIds để hiện dấu tick ✅
    List<Integer> completedIds = (List<Integer>) request.getAttribute("completedIds");
    if (completedIds == null) completedIds = new ArrayList<>();
    
    // Giữ lại userLevelStr để dùng cho Filter
            ...
            <div class="lessons-container" id="lessons-<%= catIndex %>">
                ...
                <div class="lesson-row">
                    ...
                    <div class="lesson-info">
                        <div class="lesson-name"><%= l.getDescription() %>
                            <% 
                                if (completedIds != null && completedIds.contains(l.getLessonId())) { 
                            %>
                                <span style="color: #4ade80; font-weight: bold; margin-left: 10px;">✅</span>
                            <% } %>
                        </div>
